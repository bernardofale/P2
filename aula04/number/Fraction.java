...
public class Fraction
{
  ...
  public Fraction divide(Fraction b) {
	assert invariant();
	assert b.num!=0 : "O numerador é igual a 0";
	
    int n = num*b.den;
    int d = den*b.num; 
    int q = n/d;
    assert q*d==n : "A divisão é mpossível";
  ...
  public Fraction subtract(Fraction b) {
	...
	int d = den*b.den;
	assert n+b.num*den == num*b.den : "A multiplicação é impossível";
	Fraction c = new Fraction(n, d);
	return c;
  }

  public boolean equals(Fraction b) {
	if (den==b.den && num==b.num)
	{
		return true;
	}else
		return false;
